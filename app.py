...
@app.callback([Output('output-image-upload', 'children'), Output('prediction', 'children'), Output('prediction2', 'children'), 
              Output('facts', 'children'),Output('alert-message','children')],
...
def update_output(list_of_contents):        
    ...
    if list_of_contents is not None:
        ...
        model = load_model('D:/brain-tumor-classifier-app-master (2)/brain-tumor-classifier-app-master/f_model.h5') 
        dim = (150, 150)
        ...
        return children, pred, pred2, facts_div,alert_message
    else:
